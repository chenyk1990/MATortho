...
%% Noise attenuation
d1=lo_drr3d(dn,0,120,0.004,3,1,0);	%DMSSA (when damping factor =1, there are heavy damages)
noi1=dn-d1;
...
subplot(3,1,1);imagesc([dn,d1,noi1]);caxis([-0.6,0.6]);colormap(jet);title('Initial denoising (Noisy|Denoised|Noise)');
...
subplot(3,1,2);imagesc([dn,d2,noi2]);caxis([-0.6,0.6]);colormap(jet);title('Local orthogonalization (Noisy|Denoised|Noise)');
ylabel('Time sample','Fontsize',10,'fontweight','bold');xlabel('Trace','Fontsize',10,'fontweight','bold');set(gca,'Linewidth',2,'Fontsize',10,'fontweight','bold');

subplot(3,2,5);imagesc(simi1);caxis([0,1]);colormap(jet);title('Local similarity: Initial denoising');
ylabel('Time sample','Fontsize',10,'fontweight','bold');xlabel('Trace','Fontsize',10,'fontweight','bold');set(gca,'Linewidth',2,'Fontsize',10,'fontweight','bold');

subplot(3,2,6);imagesc(simi2);caxis([0,1]);colormap(jet);title('Local similarity: Local orthogonalization');
ylabel('Time sample','Fontsize',10,'fontweight','bold');xlabel('Trace','Fontsize',10,'fontweight','bold');set(gca,'Linewidth',2,'Fontsize',10,'fontweight','bold');
...
print(gcf,'-depsc','-r300','test_localortho.eps');
print(gcf,'-dpng','-r300','test_localortho.png');
